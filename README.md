...
FunTweet is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [x] Added animation when Detail Activity is opened
* [x] Added a recyclerView in Detail Activity to enable multiple replies on the same tweet
* [x] Displaying Username of the original tweet while replying
